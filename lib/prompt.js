...
Order this group so the central intellectual task comes first - the one the assignment exists to make the student do. Supporting thinking follows in the order it should be tackled. Do NOT announce which item is central, do not label it, do not explain why it matters, do not name the skill being built. The ordering carries that on its own. You are managing the work, not teaching the subject.
