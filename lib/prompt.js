...
Most real assignments contain at least one of these, and they are exactly what a student misses reading top to bottom. An empty list is correct only when you have actively checked for all five and found none. It is not a default.

At most TWO items. This is a checklist to search with, never a quota to fill. If you find more than two, keep only the two where getting it wrong costs the most marks, and drop the rest. Two sharp items are read; four are skimmed.
...
Two sentences at most per item: what is unclear, then how to decide and what makes each reading defensible.

If looking something up would resolve it, it is not unclear - it is LEGWORK. A missing deadline is always LEGWORK and never an item here. Do not repeat a number, date, or format that already appears elsewhere in your response, and do not invent ambiguity that is not there.
