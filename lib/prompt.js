...
Every fact appears exactly once, in exactly one group. If a rule is already carried inside a task in THE WORK or THE LEGWORK, it does not also appear in THE RULES. Before you answer, read all four lists together and delete anything you have said twice. When two items refer to the same named resource, give its full name once and refer to it briefly after that; a long title repeated in full makes two different actions look like one repeated one.
