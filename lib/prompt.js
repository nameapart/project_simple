...
If the source offers alternatives the student chooses between - two or more prompts, topics or questions where only one is answered - then choosing is the first item here, the alternatives themselves go in THE RULES as a menu, and the remaining items describe what the student does whatever they picked. Never write one item per alternative. The moment they choose, every item about the others is noise.
